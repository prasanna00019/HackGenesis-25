...
import emotionalstability from '../assets/socialanxiety.jpg';
const SocialAnxietyIntermediate = () => {  
    const navigate=useNavigate();
    const handleStartButtonClick = () => {
     navigate('/home/dashboard/social-mangement/Test')
  };
  ...
  return (
    <div style={styles.body}>
      <div style={styles.container}>
        {/* Header Section */}
        <header>
          <h1 style={styles.header}>social anxiety Test</h1>
          <img
...
export default SocialAnxietyIntermediate;