...
const DepressionIntermediate = () => {
    const navigate=useNavigate();
  const handleStartButtonClick = () => {
     navigate('/home/dashboard/Depression-mangement/Test')  
    };
        ...
        <main>
          <section style={styles.intro}>
            <p style={styles.introText}>
              Feeling overwhelming sadness? Take our online depression test—it's
...
export default DepressionIntermediate;